...
#
# Generated by Vivado on Sun Oct 13 20:53:59 CEST 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../audio_processor.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../audio_processor.gen/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../audio_processor.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/media/alexey/MMC_64/Pmod-I2S2/audio_processor/audio_processor.cache/compile_simlib/vcs"
  fi
